...
// console.log(myData["World Cup Winner"])  // -> true
...
JavaScript has several ways you can loop over the items in an array, but for testing purposees, use the `forEach()` method to solve this challenge.

First, save the array to a variable named `players`. Next, loop over the array and print each player's name to the console.
