...
/*
Now you've seen an example of each valid data type in JSON: numbers, strings, Boolean values, objects, arrays, and null.
...
2. JSON doesn't even need to be an object (`{ }`) - any of the data types mentioned above could be valid JSON on their own (a single string, an array, etc.)
